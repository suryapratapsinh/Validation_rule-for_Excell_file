...
def validate_excel(input_file, validation_rules, output_path):
    ...
    # Group by 'id' to consolidate values from different columns
    df = df.groupby("id").first().reset_index()


    # Save to Excel in the desired format
    output_file = "formatted_invalid_data_7.xlsx"
...
# Example usage:
input_file = "C:/Users/Admin/PycharmProjects/validation_rules/single_col.xlsx"  # Input Excel file
